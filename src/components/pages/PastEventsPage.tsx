...
export default function PastEventsPage() {
  ...
  const loadEvents = async () => {
    try {
      ...
      const pastEvents = eventsResult.items.filter(event => event.isHeld);
      const pastConcerts = concertsResult.items.filter(concert => concert.held);
      
      setEvents(pastEvents);
      setConcerts(pastConcerts);
    } catch (error) {
                    ...
                    >
                      ...
                      >
                        <div className="relative aspect-[4/5] mb-6 overflow-hidden">
                          <Image
                            src="https://static.wixstatic.com/media/c418c8_2fcbe48bc8e340f785955a372a91a246~mv2.png?originWidth=448&originHeight=576"
                            alt={title || 'Event'}
